$('#contact-section .social-surrounding').eq(0).click(() => {
    ...
    setTimeout(() => {
        $('.copied').eq(0).css('width', '0px')
        $('.copied').eq(0).css('opacity', '0')
    }, 2000);
})
...
$('#contact-section .social-surrounding').eq(1).click(() => {
    ...
    setTimeout(() => {
        $('.copied').eq(1).css('width', '0px')
        $('.copied').eq(1).css('opacity', '0')
    }, 2000);
})
...
$('#contact-section .social-surrounding').eq(2).click(() => {
    ...
    setTimeout(() => {
        $('.copied').eq(2).css('width', '0px')
        $('.copied').eq(2).css('opacity', '0')
    }, 2000);
})
